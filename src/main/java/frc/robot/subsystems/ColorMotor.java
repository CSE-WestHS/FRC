 ...
 * private final ColorDetectionSystems COLOR_DETECTION = new
 * ColorDetectionSystem();
 ...
 * // If a 'color' button is pressed, set colorSelection variable to the color
 * selected.
 ...
 * }
 * 
 * //Set motor speed to 1.0 (max) until it has spinned the color wheel (control
 * panel) 3.5 time.
 * //Use in update() function down below.
 * 
 ...
 * COLOR_MOTOR.set(0.5);
 * Debug.printOnce("Spin Three Times: " + CURRENT + ": " + prevCOLOR + ": " +
 * colorsPassed);
 * 
 ...
 * }
 * 
 * //update function, updates color motor status every cycle/tick/loop of
 * teleopPeriodic() function in robot.java
 * public void update()
 * {
