...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() 
  {
    ...
    // (CCW rotation is positive in mathematics, but Xbox controllers return positive when you pull right.)
    final var angularVelocity = -m_angularVelocityLimiter.calculate(m_controller.getRightX()) * DriveSystem.kMaxAngularSpeed;
