...
public class OperatorInput {
    ...
    public static final Button intakeButton = new Button(controller, 1);
    public static final Button shootLowGoalButton = new Button(controller, 6);
    public static final Button shootHighGoalButton = new Button(controller, 8);
    public static final Button spitoutButton = new Button(controller, 3);
